...
export default function GolferCardHole({holeScore, currentHole, updateCurrentHole, isCurrentUser}) {
    ...
    return (
        ...
        >
            ...
            <div className='golferCardHoleShots'>
                {(isCurrentUser && (currentHole && holeScore.shots > 0)) && <GolfDecrementShots holeScore={holeScore} />}
                <h6>{holeScore.shots === 0 ? '' : holeScore.shots}</h6>
                {(isCurrentUser && currentHole) && <GolfIncrementShots holeScore={holeScore} />}
            </div>
